...
namespace productionorderservice.Migrations
{
    ...
    [Migration("20180517183413_addingDateToProductionOrder")]
    partial class addingDateToProductionOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("productionorderservice.Model.HistState", b =>
                {
                    b.Property<int>("histStatesId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("histStatesId");

                    b.HasIndex("productionOrderId");

                    b.ToTable("HistStates");
                });
            ...
            modelBuilder.Entity("productionorderservice.Model.HistState", b =>
                {
                    b.HasOne("productionorderservice.Model.ProductionOrder")
                        .WithMany("histStates")
